...
static const struct i2c_device_id ssd1306_i2c[] = {
	{ "ssd1306", 0 },
	{ }
};


static const struct of_device_id ssd1306_i2c_driver_device[] = {
	{.compatible = "ssd1306", },
	{ }
};


MODULE_DEVICE_TABLE(i2c, ssd1306_i2c);

static struct i2c_driver ssd1306_i2c_driver = {
	.driver = {
		.name = "ssd1306",
		.owner = THIS_MODULE,
        .of_match_table = ssd1306_i2c_driver_device,
	},
	.probe = ssd1306_i2c_probe,
	.remove = ssd1306_i2c_remove,
	.id_table = ssd1306_i2c,
};
